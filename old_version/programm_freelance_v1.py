...
async def send_message_bot(message, category_name, user_list, username, bot):
    ...
    # Создание сообщения
    finish_message = f"Категория: {category_name}\n\nОтправитель: @{username}\n\nСообщение от клиента:\n\n{message}\n\n------------------\nПолучите самые актуальные предложения для фрилансеров всего за 800 рублей в месяц на RubyStar Bot. Этот бот специально разработан для поиска заказов, подходящих вашим специализациям и интересам - https://t.me/RubyStar_bot\n------------------"
